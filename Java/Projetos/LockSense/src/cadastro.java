...
public class cadastro {
    public static void main(String[] args) {
        ...
        PACKAGE_NAME.dadosSeguranca novaDadosSeguranca = PACKAGE_NAME.dadosSeguranca.criarInscricao(nome, numero, codigoSeguranca, cpf, rg);

        // Adicionar a nova inscrição à lista de inscrições
        List<PACKAGE_NAME.dadosSeguranca> inscricoes = PACKAGE_NAME.dadosSeguranca.criarListaInscricoes();
        inscricoes.add(novaDadosSeguranca);
