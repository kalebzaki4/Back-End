...
public final class dadosSeguranca {
    // Variáveis para armazenar os dados da inscrição (privadas e finais)
    ...
    public static PACKAGE_NAME.dadosSeguranca criarInscricao(String nome, String numero, String codigoSeguranca, String cpf, String rg) {
        return new PACKAGE_NAME.dadosSeguranca(nome, numero, codigoSeguranca, cpf, rg);
    }
    ...
    public static List<PACKAGE_NAME.dadosSeguranca> criarListaInscricoes() {
        List<PACKAGE_NAME.dadosSeguranca> inscricoes = new ArrayList<>();
